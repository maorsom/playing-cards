...
TextureManager::~TextureManager() { m_LoadedTextures.empty(); }

std::shared_ptr<Texture>
TextureManager::FindOrLoadTexture(const std::string &filepath) {
  ...
  std::shared_ptr<Texture> newSharedTexture =
...
glm::ivec4 TextureManager::GetTileCoords(const std::string &filename,
  ...
  TextureManager_TileDefMap::const_iterator tile_it =
      foundMap->map.find(tilename);
