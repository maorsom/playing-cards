...
public:
  ...
  void SetAtlasTexture(const std::shared_ptr<Texture> &texture,
...
protected:
  ...
  virtual void GetMeshData(std::vector<float> &outVerticies,
                           std::vector<unsigned int> &outIndicies) const = 0;
